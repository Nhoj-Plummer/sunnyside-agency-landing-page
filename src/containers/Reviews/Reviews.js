...
function Reviews() {
  return (
    <div className="reviews-container">
      ...
      <Client personImg={GlobalEmily} text={"We put our trust in Sunnyside and they delivered, making sure our needs were met and ddeadlines were always hit."} name={" Emily R."} job={"Marketing Director"} />
